...
!-----------------------------------------------------------------------
    ...
    use stratiform,    only: conv_water_4rad
...
!
!  IAF: added zi and t  (April 2016)  tgicewp (Jan 2017)
!
    call cldovrlap(lchnk, ncol, tgicewp, state%zi, state%t, state%pint, cldn, nmxrgn, pmxrgn)

...
!    If not go to another bld directory eg cams1/bld and copy over
...
!  ----------------
!
!  l3+s3: lwc_max = 3.0  DONE
!    rh_min_ttl = 0.85  (from 0.90)
!    ri_base_o = 3.0*0.001
!    ri_base_l = 4.0*0.001
!
!  l1+s1: lwc_max = 2.0   DONE
!    rh_min_ttl = 0.85  (from 0.90)
!    ri_base_o = 3.0*0.001
!    ri_base_l = 4.0*0.001
!
!  l2+s2: Back to default  DONE
!    ri_base_o = 3.0*0.001
!    ri_base_l = 4.0*0.001
!
!  -------------------------
...
!-------------------------------------------------------
real(r8), parameter :: ri_base_o = 3.0*0.001
real(r8), parameter :: ri_base_l = 4.0*0.001
...
!real(r8), parameter :: rh_melt_target = 0.85
...
!
!------------------------------------------------------------------------
!real(r8), parameter :: b_precip_down = 0.0
real(r8), parameter :: b_precip_down = -0.02
...
!
!------------------------------------------------------------------------
subroutine get_tend(did_convect,land_fraction,om5,this_lat,tstep)
!------------------------------------------------------------------------
!
!  What to use
